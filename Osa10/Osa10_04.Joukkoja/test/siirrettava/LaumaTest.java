...
public class LaumaTest {
    ...
    private final String PAKKAUS = "siirrettava";
    private final String LUOKKA = "Lauma";
    private Class laumaClass;
    private Class olioClass;
    private String klassName = "siirrettava.Lauma";
    ...
    public void eiYlimaaraisiaMuuttujia() {
        saniteettitarkastus(klassName, 1, "lauman jäsenet muistavat oliomuuttujat");
    }
    ...
    public Siirrettava newElio(int t1, int t2) throws Throwable {
        String klassName = "siirrettava.Elio";
        Reflex.ClassRef<Object> classRef;
        classRef = Reflex.reflect(klassName);
    ...
    public void onMetodiLisaaLaumaan() throws Throwable {
        ...
        assertTrue("Luokalla Lauma pitää olla metodi public void lisaaLaumaan(Siirrettava siirrettava)",
                classRef.method(e, "lisaaLaumaan").returningVoid().taking(Siirrettava.class).isPublic());

        String v = "virheen aiheutti koodi\n"
                + "Lauma e = new Lauma();\n"
                + "e.lisaaLaumaan( new Elio(1,1) );\n";

        classRef.method(e, "lisaaLaumaan")
                .returningVoid()
    ...
    private void lisaaLaumaan(Object e, Siirrettava s, String v) throws Throwable {
        classRef.method(e, "lisaaLaumaan").returningVoid().taking(Siirrettava.class).withNiceError(v).invoke(s);
    }
