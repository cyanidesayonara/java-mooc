...
public class NumerotiedusteluTest {
    ...
    String klassName = "numerotiedustelu.Paaohjelma";
    ...
    public void luokkaJulkinen() {
        assertTrue("Pakkauksessa numerotiedustelu sijaitsevan luokan Paaohjelma pitää olla julkinen, eli se tulee määritellä\npackage numerotiedustelu;\n\npublic class Paaohjelma {...\n}", klass.isPublic());
    }
