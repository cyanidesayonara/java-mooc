...
public class B_MuutoshistoriaTest {
    ...
    String klassName = "varastot.Muutoshistoria";
    ...
    @Test
    @Points("10-06.5")
    public void onMetodiSuurinMuutos() throws Throwable {
        String metodi = "suurinMuutos";
        String virhe = "tee luokalle Muutoshistoria metodi public double suurinMuutos()";
        Object o = newMuutoshistoria();
        ...
        classRef.method(o, "lisaa").returningVoid().taking(double.class).withNiceError(v).invoke(99.0);
        classRef.method(o, "lisaa").returningVoid().taking(double.class).withNiceError(v).invoke(100.0);
    ...
    @Test
    @Points("10-06.5")
    public void onMetodiVarianssi() throws Throwable {
        String metodi = "varianssi";
        String virhe = "tee luokalle Muutoshistoria metodi public double varianssi()";
        Object o = newMuutoshistoria();
    ...
    @Test
    @Points("10-06.5")
    public void suurinMuutosLasketaanOikein1() throws Throwable {
        Object mh = newMuutoshistoria();
        ...
        assertEquals(k + "mh.suurinMuutos() ", 2, suurinMuutos(mh, k + "mh.suurinMuutos();"), 0.01);
    }

    @Test
    @Points("10-06.5")
    public void suurinMuutosLasketaanOikein2() throws Throwable {
        Object mh = newMuutoshistoria();

        String k = "tarkasta koodi\nmh = new Muutoshistoria();\nmh.lisaa(5.0); ";
        lisaa(mh, 5, k);

        assertEquals(k + "mh.suurinMuutos() ", 0, suurinMuutos(mh, k + "mh.suurinMuutos();"), 0.01);
    }

    @Test
    @Points("10-06.5")
    public void suurinMuutosLasketaanOikein3() throws Throwable {
        Object mh = newMuutoshistoria();
        ...
        assertEquals(k + "mh.suurinMuutos() ", 3, suurinMuutos(mh, k + "mh.suurinMuutos();"), 0.01);
    }

    @Test
    @Points("10-06.5")
    public void suurinMuutosLasketaanOikein4() throws Throwable {
        ...
        assertEquals(k + "mh.suurinMuutos() ", 11, suurinMuutos(mh, k + "mh.suurinMuutos();"), 0.01);
    }

    @Test
    @Points("10-06.5")
    public void varianssiLasketaanOikein1() throws Throwable {
        Object mh = newMuutoshistoria();
        ...
        assertEquals(k + "mh.varianssi() ", 0, varianssi(mh, k + "mh.varianssi();"), 0.01);
    }

    @Test
    @Points("10-06.5")
    public void varianssiLasketaanOikein2() throws Throwable {
        Object mh = newMuutoshistoria();
        String k = "tarkasta koodi\nmh = new Muutoshistoria();\nmh.lisaa(3.0);\nmh.lisaa(1.0);\nmh.lisaa(2.0); ";
        ...
        assertEquals(k + "mh.varianssi() ", 1, varianssi(mh, k + "mh.varianssi();"), 0.01);
    }

    @Test
    @Points("10-06.5")
    public void varianssiLasketaanOikein3() throws Throwable {
        Object mh = newMuutoshistoria();
        ...
        assertEquals(k + "mh.varianssi() ", 21.6, varianssi(mh, k + "mh.varianssi();"), 0.01);
    }
