...
import varastot.Varasto;

public class C_MuistavaTuotevarastoTest {

    String klassName = "varastot.MuistavaTuotevarasto";
    ...
    public void periiLuokanTuotearasto() {
        ...
        assertTrue("Luokan MuistavaTuotevarasto tulee periä luokka Tuotevarasto", sc.getName().equals("varastot.Tuotevarasto"));
    }
    ...
    public void alkuSaldoOnVarastonAlkusaldona() throws Throwable {
        varastot.Varasto v = (varastot.Varasto) newMustavaTuotevarasto("vilja", 10, 5);
    ...
    @Test
    @Points("10-06.9")
    public void tulostaAnalyysiSisaltaaVarianssinJaSuurimmanMuutosen() throws Throwable {
        MockInOut io = new MockInOut("");
        Object v = newMustavaTuotevarasto("olut", 10, 5);

        String k = "MuistavaTuotevarasto mtv = new MuistavaTuotevarasto(\"olut\", 10, 5);\n"
                + "mtv.tulostaAnalyysi();\n";

        tulostaAnalyysi(v, k);
        String[] rivit = io.getOutput().split("\n");
        String haettava = "Varianssi:";
        String rivi = hae(rivit, haettava);
        assertTrue("Metodin tulostaAnalyysi kutsun tulee tulostaa rivi jossa on merkkijono \"" + haettava + "\"", rivi != null);
        haettava = "Suurin muutos:";
        rivi = hae(rivit, haettava);
        assertTrue("Metodin tulostaAnalyysi kutsun tulee tulostaa rivi jossa on merkkijono \"" + haettava + "\"", rivi != null);
    ...
    @Test
    @Points("10-06.9")
    public void laajennettuTulostaAnalyysiToimii1() throws Throwable {

        MockInOut io = new MockInOut("");
        Object v = newMustavaTuotevarasto("kahvi", 10, 1);

        String k = "Toimiiko tulostaAnalyysi oikein? Koodilla\n"
                + "mtv = new MuistavaTuotevarasto(\"kahvi\", 10, 1);\n"
                + "mtv.lisaaVarastoon(9);\nmtv.otaVarastosta(6);\n"
                + "mtv.tulostaRaportti();\n"
                + "tulostuu rivi \"";

        lisaaVarastoon(v, 9, k);
        otaVarastosta(v, 6, k);
        ...
        rivi = hae(rivit, haettava);
        assertTrue(k + rivi + "\"\n"
                + "varianssin pitäisi olla 21.0", rivi.contains("21"));

        haettava = "Suurin muutos:";
        rivi = hae(rivit, haettava);
        assertTrue(k + rivi + "\"\n"
                + "suurimman muutoksen pitäisi olla 9.0", rivi.contains("9"));

    }

    @Test
    @Points("10-06.9")
    public void laajennettuTulostaAnalyysiToimii2() throws Throwable {
        MockInOut io = new MockInOut("");
        Object v = newMustavaTuotevarasto("kahvi", 10, 2);
        String k = "Toimiiko tulostaAnalyysi oikein? Koodilla \n"
                + "mtv = new MuistavaTuotevarasto(\"kahvi\", 10, 2);\n"
        ...
        rivi = hae(rivit, haettava);
        assertTrue(k + rivi + "\"\n"
                + "varianssin pitäisi olla 10.0", rivi.contains("10"));

        haettava = "Suurin muutos:";
        rivi = hae(rivit, haettava);
        assertTrue(k + rivi + "\"\n"
                + "suurimman muutoksen pitäisi olla 6.0", rivi.contains("6"));
    }
