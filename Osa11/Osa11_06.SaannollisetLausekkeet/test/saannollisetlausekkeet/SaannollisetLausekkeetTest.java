...
import saannollisetlausekkeet.Tarkistin;
...
public class SaannollisetLausekkeetTest {
    ...
    String klassName = "saannollisetlausekkeet.Tarkistin";
    ...
    private boolean kellonaika(String mj, String v) throws Throwable {
        Object t = Reflex.reflect("saannollisetlausekkeet.Tarkistin").constructor().takingNoParams().invoke();
        String metodi = "kellonaika";
    ...
    private void noForbiddens() {
        try {
            Scanner lukija = new Scanner(new File("src/saannollisetlausekkeet/Tarkistin.java"));
            int mainissa = 0;
