...
public class HenkilostoTest<_Koulutus, _Henkilo, _Tyontekijat> {
    ...
    public void atStart() {
        try {
            _KoulutusRef = Reflex.reflect("henkilosto.Koulutus");
            _HenkiloRef = Reflex.reflect("henkilosto.Henkilo");
            _TyontekRef = Reflex.reflect("henkilosto.Tyontekijat");
        } catch (Throwable e) {
        }
    }
    ...
    public void onEnumKoulutus() {
        String luokanNimi = "henkilosto.Koulutus";
        try {
            _KoulutusRef = Reflex.reflect(luokanNimi);
        } catch (Throwable t) {
            fail("tee pakkauseen henkilosto enum Koulutus");
        }
        assertTrue("tee pakkauseen henkilosto enum Koulutus", _KoulutusRef.isPublic());
        Class c = _KoulutusRef.cls();
        assertTrue("tee pakkauseen henkilosto enum Koulutus, nyt taisit tehdä normaalin luokan", c.isEnum());
    }
    ...
    public void onLuokkaHenkilo() {
        String luokanNimi = "henkilosto.Henkilo";
        _HenkiloRef = Reflex.reflect(luokanNimi);
        assertTrue("tee pakkauseen henkilosto luokka Henkilo", _HenkiloRef.isPublic());
    }
    ...
    public void onLuokkaTyontekijat() {
        String luokanNimi = "henkilosto.Tyontekijat";
    ...
    private Object getKoulutus(Object olio) throws Exception {
        ...
        Class c = ReflectionUtils.findClass("henkilosto.Henkilo");
    ...
    private Object tyontekijat() {
        Class c = ReflectionUtils.findClass("henkilosto.Tyontekijat");
    ...
    private void iteraattoriKaytossa() {
        try {
            Scanner lukija = new Scanner(new File("src/henkilosto/Tyontekijat.java"));
            int metodissa = 0;
