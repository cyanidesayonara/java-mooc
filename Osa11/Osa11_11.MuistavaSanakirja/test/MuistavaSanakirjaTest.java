...
public class MuistavaSanakirjaTest {
    ...
    public void parametrillinenKonstruktori() throws Throwable {
        ...
        String v = "virheen aiheutti koodi new MuistavaSanakirja(\"src/sanat.txt\");";
        ctor.withNiceError(v).invoke("/test/sanat.txt");
    }
    ...
    public void metodiLataa() throws Throwable {
        ...
        String v = "MuistavaSanakirja s = new MuistavaSanakirja(\"src/sanat.txt\");\n";

        Object olio = luo("test/sanat.txt", v);
    ...
    public void olematonSanakirjaTiedosto() throws Throwable {
        String v = ""
                + "MuistavaSanakirja s = new MuistavaSanakirja(\"src/tiedostoJotaEiOleOlemassa.txt\");\n"
                + "s.lataa();\n";

        Object o = luo("test/tiedostoJotaEiOleOlemassa", v);
    ...
    public void olemassaolevassaSanakirjatiedostossaSailyvatSamatTiedot() throws Throwable {
        String tiedosto = "test/sanat.txt";
    ...
    private void teeTiedosto(String tiedosto) {
        ...
        try {
            ...
            fail("paha ongelma, ota yhteyttä luennoijaan");
        }
    }
