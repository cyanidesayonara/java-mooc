...
public class KirjastonTietojarjestelmaTest<_Kirja> {
    ...
    public void eiYlimaaraisiaMuuttujiaLuokassaKirja() {
        saniteettitarkastus(kirjaLuokka, 3, "nimikkeen, julkaisijan ja julkaisuvuoden muistavat oliomuuttujat");
    }
    ...
    private void kirjastoKayttaaStringUtilsiaLukija() {
        try {
            Scanner lukija = new Scanner(new File("src/Kirjasto.java"));
