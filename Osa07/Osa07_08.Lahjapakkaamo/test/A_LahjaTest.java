...
@Points("07-08.1")
public class A_LahjaTest {

    String klassName = "Lahja";
    ...
    public void testaaKonstruktori() throws Throwable {
        ...
        String v = "virheen aiheutti koodi new Lahja(\"Puhelin\", 1);";
    ...
    @Test
    @Points("07-08.1")
    public void lahjaGetNimiMetodi() throws Throwable {
        ...
        String v = "\nVirheen aiheuttanut koodi Lahja t = new Lahja(\"Kirja\", 2); "
                + "t.getNimi();";

        assertEquals("Tarkasta koodi Lahja t = new Lahja(\"Kirja\", 2); "
        ...
        v = "\nVirheen aiheuttanut koodi Lahja t = new Lahja(\"Auto\", 800); "
                + "t.getNimi();";

        assertEquals("Tarkasta koodi Lahja t = new Lahja(\"Auto\", 800);  "
    ...
    @Test
    @Points("07-08.1")
    public void lahjaGetPainoMetodi() throws Throwable {
