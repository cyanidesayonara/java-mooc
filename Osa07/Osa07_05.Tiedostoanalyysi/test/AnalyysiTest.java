...
public class AnalyysiTest {
    ...
    public void setUp() {
        ...
        try {
            analyysiClass = ReflectionUtils.findClass(luokanNimi);
        } catch (Throwable t) {
            fail("Olethan luonut luokan " + luokanNimi + "?");
        }
    }
    ...
    public void onKonstruktoriAnalyysi() throws Throwable {
        ...
        String v = "virheen aiheutti koodi new Analyysi(\"testitiedosto.txt\");\n";
        ctor.withNiceError(v).invoke("testitiedosto.txt");
    }

    public Object luo(String tiedosto) throws Throwable {
        return classRef.constructor().taking(String.class).invoke(tiedosto);
    }
    ...
    public void onMetodiRivimaara() throws Throwable {
        ...
        String k = "Analyysi a = new Analyysi(\"testitiedosto.txt\");\n"
                + "a.rivimaara();";
    ...
    private void testaaRivimaaraMetodia(String tiedosto, int riveja, String tdst) {
        int rivit = -1;
    ...
    private void testaaMerkkejaMetodia(String tiedosto, int merkkeja, String tdst) {
        int merkit = -1;
        Object riviObj = luoAnalyysiOlio(tiedosto);
    ...
    private Object luoAnalyysiOlio(String tiedosto) {
        try {
            Constructor riviConstruktor = ReflectionUtils.requireConstructor(analyysiClass, String.class);
    ...
    public void yksiRivi() {
        try {
            ...
            n.flush();
            n.close();
            testaaRivimaaraMetodia(eka.getAbsolutePath(), 1, "sana1");
    ...
    public void viisiRiviaTest() {
        try {
            ...
            n.flush();
            n.close();
            testaaRivimaaraMetodia(eka.getAbsolutePath(), 5, "sana1\nsana2\nsana3\nsana4\nsana5");
        } catch (IOException ex) {
            fail("Testitiedoston kirjoittaminen ei onnistunut! Lisätietoa: " + ex);
        }
    }
    ...
    public void kymmenenRiviaTest() {
        try {
            ...
            n.flush();
            n.close();
            testaaRivimaaraMetodia(eka.getAbsolutePath(), 10, "sana1\naa\nbb\ncc\ndd  dd\nee e\nfff\nggg\nh\nsana1");
        } catch (IOException ex) {
            fail("Testitiedoston kirjoittaminen ei onnistunut! Lisätietoa: " + ex);
        }
    }
    ...
    public void viisiMerkkiaJaRivinvaihto() {
        try {
            ...
            n.flush();
            n.close();
            testaaMerkkejaMetodia(eka.getAbsolutePath(), 6, "arska");
        } catch (IOException ex) {
    ...
    public void kaksiMerkinRivia() {
        try {
            ...
            n.flush();
            n.close();
            testaaMerkkejaMetodia(eka.getAbsolutePath(), 4, "a\nb\n");
        } catch (IOException ex) {
            fail("Testitiedoston kirjoittaminen ei onnistunut! Lisätietoa: " + ex);
        }
    }
    ...
    public void rivinvaihtoLasketaan() {
        try {
            ...
            n.flush();
            n.close();
            testaaMerkkejaMetodia(eka.getAbsolutePath(), 18, "arska\nmusta\npekka");
        } catch (IOException ex) {
            fail("Testitiedoston kirjoittaminen ei onnistunut! Lisätietoa: " + ex);
        }
    }
    ...
    public void molemmatMetoditToimiiPerakkain() throws Throwable {
        Object o = luo("test/testitiedosto.txt");

        assertTrue("Lisää luokalle Analyysi metodi public int merkkeja()", classRef.method(o, "merkkeja").returning(int.class).takingNoParams().isPublic());

        String k = "Analyysi a = new Analyysi(\"test/testitiedosto.txt\");\n"
                + "a.merkkeja();\n";
